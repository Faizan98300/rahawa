    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-[#f7f7f7]">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold mb-6 text-center">Rawaha: Here for small business since 1995.</h2>
          <p className="text-gray-700 mb-6 leading-relaxed">
            For more than 20 years, Rawaha has helped small business owners, entrepreneurs and dreamers create custom
