...
export default function AboutPage() {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-[#444545] to-[#003d7a] text-white py-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg leading-relaxed mb-4">
                  Rawaha is a trusted paper and printing seller in Lahore, located in Urdu Bazar, serving customers across Pakistan since 2016. We provide premium quality paper, printing materials, and custom solutions for businesses, schools, offices, and individuals.
                  Known by many customers as Rawaha (also searched as Rahawa), we are recognized for best prices, consistent quality, and nationwide delivery. Our physical store in Urdu Bazar Lahore makes us one of the most reliable paper sellers in Lahore.
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-5xl font-bold text-[#0066cc] mb-2">3+</div>
        ...
        {/* Our Commitment */}
        <section className="bg-[#444545] text-white py-16">
          <div className="container mx-auto px-4">
